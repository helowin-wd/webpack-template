...
class ObjectRefImpl {
  constructor(_object, _key, _defaultValue) {
    ...
    let shallow = true;
    let obj = _object;
    if (!reactivity_esm_bundler_isArray(_object) || !reactivity_esm_bundler_isIntegerKey(String(_key))) {
      do {
...
var exportHelper = __webpack_require__(4788);
;// ./src/App.vue
...
var str = "Hello World";
console.log(str);
var arr = ["javascript", "typescript", "python"].map(function (item) {
